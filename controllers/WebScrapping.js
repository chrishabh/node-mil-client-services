...
async function webScrapping(req, res) {
    ...
    // const listItems =  $(".elementor-element-6a451fe").find(".elementor-widget-container");

    // console.log(listItems.length);

    $(".elementor-element-6a451fe").find(".elementor-widget-container").each((index,element) => {
          // extracting the data of interest
          const pageUrl = $(element).find(".elementor-image-box-content .elementor-image-box-title").attr("data-lazy-src")
    ...
    const scrapedDataJSON = JSON.stringify(industries)
    res.success(industries);
}
